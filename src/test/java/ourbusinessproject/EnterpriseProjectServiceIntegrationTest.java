...
public class EnterpriseProjectServiceIntegrationTest {
    ...
    public void testFindAllProjects() {
        ...
        enterpriseProjectService.save(new Project("p4", "p4 description", enterprise));
        enterpriseProjectService.save(new Project("p5", "p5 description", enterprise));
        enterpriseProjectService.save(project);
        ...
        assertThat(projects.get(1).getTitle(), is("p4"));
        assertThat(projects.get(2).getTitle(), is("p5"));
